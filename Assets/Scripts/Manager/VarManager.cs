...
public class VarManager : MonoBehaviour
{
    ...
    public static int StateToSkill(string state)
    {
        ...
        return state switch
        {
            ...
            "Nageru" => Constant.SkillName.Kagetsu.Nageru,
            "Sangiri" => Constant.SkillName.Kagetsu.Sangiri,
            "IttoRyotan" => Constant.SkillName.Kagetsu.IttoRyotan,
            "NageKunai" => Constant.SkillName.Kagetsu.NageKunai,
